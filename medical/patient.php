                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>							
										...
										<form action="../includes/insert-patient.php?csrf=$_SESSION['csrf_token']" method="post">
                                            ...
                                            <td><input type="text" class="form-control" name="blood_group" placeholder="Blood Group"></textarea></td>
...
$query = "SELECT first_name, AES_DECRYPT(first_name, $SECRET),last_name, AES_DECRYPT(last_name, $SECRET),dob, AES_DECRYPT(dob, $SECRET), address, AES_DECRYPT(address, $SECRET), blood_group, AES_DECRYPT(blood_group, $SECRET), phone, AES_DECRYPT(phone, $SECRET),email, AES_DECRYPT(email, $SECRET) FROM patient"; //You don't need a ; like you do in SQL
